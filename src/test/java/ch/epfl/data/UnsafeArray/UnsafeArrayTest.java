...
public class UnsafeArrayTest {
    ...
    public void testReleasingMemory() {
        ...
        for (int i = 0; i < 100000; i++) {
            ...
            if (i % 100 == 0)
                System.gc(); // Unclear behaviour. Needed for JDK1.7.0.75 x86 on Linux Mint.
        }
    }

    @Test
    public void testComplexClassWithString() {
        DeepTestclass c1 = new DeepTestclass(12, 10d, new ShallowTestclass(66,
                'a', 'd', 161.5d));
        UnsafeArray<DeepTestclass> complexArr = new UnsafeArray<DeepTestclass>(
                DeepTestclass.class, 5);
